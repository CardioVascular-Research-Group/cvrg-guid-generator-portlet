...
package com.jhu.cvrg.portal.guidgenerator.service.messaging;

import com.jhu.cvrg.portal.guidgenerator.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			StudyLocalServiceUtil.clearService();

			SiteLocalServiceUtil.clearService();

			StudySiteLocalServiceUtil.clearService();

			SubjectHashLocalServiceUtil.clearService();
		}
	}
